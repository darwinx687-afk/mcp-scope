...
MCP Scope 现在已经有公开 GitHub 仓库和一个公开 GitHub prerelease，用于第一次公开发布审查。当前 release 仍然只是 prerelease，还没有转为 final/stable release。
...
- 已创建 `v0.1.0-preview` tag 和公开 prerelease。
...
- GitHub release 是公开 prerelease，不是 final/stable release。
